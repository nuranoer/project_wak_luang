...
Route::post('/admin/produk/simpan', [AdminController::class, 'store'])->name('admin.store');
Route::post('/admin/produk/edit/{id}', [AdminController::class, 'edit'])->name('admin.edit');
Route::get('/admin/produk/hapus/{id}', [AdminController::class, 'hapus'])->name('admin.produk.hapus');